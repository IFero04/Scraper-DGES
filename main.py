from console import clear_console, add_dot_every_second, update_loading_bar
...
def main():
    ...
    itens_alunos = []
    with alive_bar(len(cursos), spinner='crab') as bar:
        for curso in cursos:
    ...
    print(f'\nA ESCREVER DADOS PARA CSV [alunos_{escolha}.csv]')
